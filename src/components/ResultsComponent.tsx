...
import { CheckCircle, XCircle, Trophy, RotateCcw, User, BarChart3 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
      <div className="container mx-auto max-w-4xl">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Exam completed successfully</p>
              </div>
            </div>
            <div className={`px-4 py-2 rounded-full text-white font-bold text-lg ${gradeBadge.color}`}>
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mb-2 animate-fade-in">Exam Results</h1>
        ...
        <Card className="mb-8 shadow-lg">
          ...
          <CardContent className="text-center p-8">
            <div className={`text-6xl font-bold mb-4 animate-pulse ${getScoreColor(score, questions.length)}`}>
            ...
            <div className="flex gap-4 justify-center flex-wrap">
              <Button onClick={handleRetakeExam} className="bg-blue-600 hover:bg-blue-700 transition-colors">
